            ...
            <?php foreach ($videos as $video): ?>
                <li class="li">
                    ...
                    <div class="btn-videos">
                        ...
                        <?php endif; ?>
                        <button class="btn btn-secondary btn-video">
                                <a href="data:video/mp4;base64,<?php echo base64_encode($video['fichier']); ?>" download="<?php echo htmlspecialchars($video['titre']); ?>.mp4">Télécharger</a>
                        </button>
                    </div>
                </li>
            <?php endforeach; ?>
